...
f5=dd_most_active.sort_values(by=['Volume'], ascending=False)
...
f2.to_csv('/home/ec2-user/environment/x3/stocks/x4/output55.txt',sep=' ',mode='w+')
...
f3.to_csv('/home/ec2-user/environment/x3/stocks/x4/output55.txt',sep=' ',mode='w+')
