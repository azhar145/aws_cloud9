...
df['5day_delta_a']=df['Close'].shift(5)
df['5day_delta_b']=df['Close']-df['5day_delta_a']
df['5day_delta']=df['5day_delta_b'].round(2)


df['10day_delta_a']=df['Close'].shift(10)
df['10day_delta_b']=df['Close']-df['10day_delta_a']
df['10day_delta']=df['10day_delta_b'].round(2)
...
'''
aa=pd.concat([b1,b6,b2,b3,b4,b5,b7,b8,b9],axis=1)
aa.loc[len(aa)]=['','','8','8','5','ttt','0','6','7']
aa=aa[1:]
#print(aa.columns)
